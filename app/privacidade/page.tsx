    ...
    <div className="flex min-h-screen flex-col">
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="prose max-w-none">
          ...
          <p><span style={{color: "rgb(68, 68, 68)"}}>A sua privacidade é importante para nós. É política do White Shining respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="WhiteShining.com">White Shining</a>, e outros sites que possuímos e operamos.</span></p>
          ...
          <p><span style={{color: "rgb(68, 68, 68)"}}>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o White Shining oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
          <ul>
            ...
            <li><span style={{color: "rgb(68, 68, 68)"}}>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do White Shining, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
          </ul>
          ...
          <p><span style={{color: "rgb(68, 68, 68)"}}>Esta política é efetiva a partir de 21 May 2025 12:39</span></p>
        </div>
      </main>
      <Footer />
    </div>
